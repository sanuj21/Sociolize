...
},{}],"view/baseView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.togglePasswordText = exports.globalVars = exports.DOMElements = void 0;
...
var DOMElements = {
  ...
  modalBackBtnArr: Array.from(document.querySelectorAll('.modal__header__backBtn')),
  modalSearchInput: document.querySelector('.modal-search__header__search__input'),
  ...
  passwordToggleBtn: document.querySelector('.form__field__password__toggleBtn'),
  ...
  textareaFlexibleArr: Array.from(document.querySelectorAll('.textarea--flexible')),
...
var globalVars = {
  loggedInUserId: DOMElements.body.dataset.userid || null,
  // IF EXIST
  inputUsernameValue: DOMElements.inputUsername ? DOMElements.inputUsername.value : null,
  animateInToast: getComputedStyle(DOMElements.notifyFade).animationDuration.split('s')[0] * 1000
}; // ########################
// TOGGELING PASSWORD TEXT AND ICON

exports.globalVars = globalVars;

var togglePasswordText = function togglePasswordText() {
  if (DOMElements.inputPassword.type === 'password') {
    DOMElements.inputPassword.type = 'text';
    DOMElements.formLogin.querySelector(".form__field__password__toggleBtn__svg use").setAttribute('xlink:href', '/icons/sprite.svg#icon-visibility_on');
  } else {
    DOMElements.inputPassword.type = 'password';
    DOMElements.formLogin.querySelector(".form__field__password__toggleBtn__svg use").setAttribute('xlink:href', '/icons/sprite.svg#icon-visibility_off');
  }
}; // ########################


exports.togglePasswordText = togglePasswordText;
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"util/utilBase.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeLoader = exports.showLoader = exports.autoSizeTextarea = void 0;
...
var showLoader = function showLoader(el) {
  var modalLoader = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var classSpinner = 'spinner';
  ...
  var loaderMarkup = "\n    <svg class = \"".concat(classSpinner, "\">\n          <use xlink:href=\"/icons/sprite.svg#icon-spinner9\"></use>\n    </svg>\n  ");
  el.insertAdjacentHTML('afterbegin', loaderMarkup);
};

exports.showLoader = showLoader;

var removeLoader = function removeLoader(el) {
  var modalLoader = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  el.querySelector('.spinner').parentNode.removeChild(el.querySelector('.spinner'));
...
},{}],"util/dateUtil.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fromNowPast = void 0;

// RETURNS TIME FROM NOW
var fromNowPast = function fromNowPast(dateMilli) {
  var differTime = Date.now() - dateMilli;
  var ago = ''; // CONVERTING THE MILLISECONDS INTO DAY, HOUR ETC.

  var weeks, days, hours, minutes, secs;
  weeks = Math.floor(differTime / (1000 * 60 * 60 * 24 * 7));
  differTime -= weeks * 1000 * 60 * 60 * 24 * 7;
  ago = "".concat(weeks, " week").concat(weeks > 1 ? 's' : '', " ago"); //##

  if (!weeks) {
    days = Math.floor(differTime / (1000 * 60 * 60 * 24));
    differTime -= days * 1000 * 60 * 60 * 24;
    ago = "".concat(days, " day").concat(days > 1 ? 's' : '', " ago"); //##

    if (!days) {
      hours = Math.floor(differTime / (1000 * 60 * 60));
      differTime -= hours * 1000 * 60 * 60;
      ago = "".concat(hours, " hour").concat(hours > 1 ? 's' : '', " ago"); //##

      if (!hours) {
        minutes = Math.floor(differTime / (1000 * 60));
        differTime -= minutes * 1000 * 60;
        ago = "".concat(minutes, " min").concat(minutes > 1 ? 's' : '', " ago"); //##

        if (!minutes) {
          secs = Math.floor(differTime / 1000);
          ago = "".concat(secs, " sec").concat(secs > 1 ? 's' : '', " ago");
        }
      }
    }
  }
...
exports.fromNowPast = fromNowPast;
},{}],"view/commentView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showComments = exports.handleClickConfirmationModal = exports.handleClickCommentModal = exports.getComments = void 0;

var _axios = _interopRequireDefault(require("axios"));

var baseView = _interopRequireWildcard(require("./baseView"));

var utilBase = _interopRequireWildcard(require("../util/utilBase"));

var _dateUtil = require("../util/dateUtil");
...
var singleCommentMarkup = function singleCommentMarkup(el) {
  var agoComment = (0, _dateUtil.fromNowPast)(Date.parse(el.commentedOn));
  var userId = baseView.DOMElements.body.dataset.userid || null; // SHOW A DELETE BUTTON ON COMMENT, THAT THE LOGGED USER HAS POSTED

  var deleteComment = userId === el.commentedBy.id ? "<div class=\"post__comment__delete\">Delete</div>" : '';
  var likes = el.likes && el.likes.length > 0 ? "".concat(el.likes.length, " Likes") : '';
  var markUp = "<!-- ONE COMMENT BOX-->\n        <div class=\"post__comment post__comment--modal\" data-commentid='".concat(el.id, "'>\n          <div class=\"post__comment__description post__comment__description--modal\">\n            <a class=\"post__comment__user\" href = \"/user/").concat(el.commentedBy.username, "\">").concat(el.commentedBy.username, " : </a>").concat(el.comment, "\n          </div>\n          <div class=\"post__comment__footer\">\n            <div class=\"post__comment__time\">").concat(agoComment, "</div>\n            ").concat(deleteComment, "\n            <div class=\"post__comment__likesTotal\">").concat(likes, "</div>\n            <div class=\"post__comment__reply\">Reply</div>\n            <svg class=\"post__comment__icon post__comment__icon--like\">\n              <use xlink:href=\"icons/sprite.svg#icon-favorite_outline\"></use>\n            </svg>\n          </div>\n        </div>\n        <!-- ############################# -->");
  return markUp;
}; //#######################################
...
var getComments = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postId) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts/").concat(postId, "/comments")
            });

          case 2:
            res = _context.sent;
            return _context.abrupt("return", res.data.docs);
...
var askForConfirmation = function askForConfirmation() {
...
var submitComment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var comment, postId, res, commentObj, commentMarkup;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            comment = baseView.DOMElements.commentInput.value;
          ...
          case 3:
            ...
            postId = baseView.DOMElements.modalComments.dataset.postid || null;
          ...
          case 7:
            ...
            commentObj = res.data.doc;
            commentMarkup = singleCommentMarkup(commentObj);
            baseView.DOMElements.modalCommentsBody.insertAdjacentHTML('afterbegin', commentMarkup); // EMPTY THE INPUT AFTER POSTING
...
var commentElToDelete;

var handleClickCommentModal = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            postId = baseView.DOMElements.modalComments.dataset.postid || null; // HANDLING THE CLICK ON POST BTN

            if (!(e.target.matches('.submit__comment') || e.target.matches('.submit__comment *'))) {
              _context3.next = 6;
              break;
            }
          ...
          case 6:
            ...
            if (e.target.matches('.post__comment__delete') || e.target.matches('.post__comment__delete *')) {
  ...
  return function handleClickCommentModal(_x2) {
...
exports.handleClickCommentModal = handleClickCommentModal;

var handleClickConfirmationModal = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var postId, commentId, res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            if (e.target.matches('.modal-confirmation__btns__btn')) {
              _context4.next = 2;
              break;
            }
          ...
          case 2:
            // CLOSE THE MODAL
            baseView.DOMElements.modalConfirmation.classList.remove('modal--showTop'); // IF CLICK ON YES, DELETE THE COMMENT
            ...
            postId = baseView.DOMElements.modalComments.dataset.postid || null;
            commentId = commentElToDelete.dataset.commentid;
            utilBase.showLoader(baseView.DOMElements.modalForLoader, true); // DELETING THE COMMENT FROM DB

            _context4.next = 10;
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts/").concat(postId, "/comments/").concat(commentId)
            });

          case 10:
            res = _context4.sent;
            utilBase.removeLoader(baseView.DOMElements.modalForLoader, true); // UPDATING THE UI
  ...
  return function handleClickConfirmationModal(_x3) {
...
exports.handleClickConfirmationModal = handleClickConfirmationModal;

var showComments = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(el, e) {
    var postId, comments, commentsMarkup;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 8;
            return getComments(el.dataset.postid || null);
          ...
          case 8:
            ...
            baseView.DOMElements.modalCommentsBody.insertAdjacentHTML('beforeend', commentsMarkup); // FOCUS THE INPUT WHEN CLICKED ON COMMENT ICON

            baseView.DOMElements.commentInput.scrollIntoView();

            if (e.target.matches('.post__actions__icon--comment') || e.target.matches('.post__actions__icon--comment *')) {
  ...
  return function showComments(_x4, _x5) {
...
},{"axios":"../../node_modules/axios/index.js","./baseView":"view/baseView.js","../util/utilBase":"util/utilBase.js","../util/dateUtil":"util/dateUtil.js"}],"view/customAlert.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showToastNotification = exports.alertPrimary = void 0;
...
var removePrimaryAlert = function removePrimaryAlert(resolve, url) {
  return function () {
...
var alertPrimary = function alertPrimary(msg, url) {
  ...
  return new Promise(function (resolve, reject) {
    document.querySelector('.modalAlert__btn--ok').addEventListener('click', removePrimaryAlert(resolve, url));
  });
...
var showToastNotification = function showToastNotification(note) {
...
exports.showToastNotification = showToastNotification;
},{"./../view/baseView":"view/baseView.js"}],"controller/profile.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadPic = exports.follow = void 0;
...
// FOLLOWING ACCOUNT
var follow = function follow(userId, el) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            el.textContent = 'Following'; // UPDATE THE USER DOC
          ...
          case 7:
            ...
            el.textContent = 'Follow'; // UPDATE THE USER DOC
...
var addProfilePicUI = function addProfilePicUI(user) {
  var imgMarkup = "<img src=\"/images/users/".concat(user.photo, "\" class = \n      \"profile__pic__img\" alt=\"").concat(user.name, "\"/>"); // REMOVING THE OLD IMG OR ICON, BEFORE ADDING THE NEW IMG

  baseView.DOMElements.profielPicImg.parentNode.removeChild(baseView.DOMElements.profielPicImg);
  baseView.DOMElements.profielPicWrap.insertAdjacentHTML('afterbegin', imgMarkup);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (baseView.DOMElements.userPhotoInput && baseView.DOMElements.userPhotoInput.files && baseView.DOMElements.userPhotoInput.files.length > 0) {
                  file = baseView.DOMElements.userPhotoInput.files[0]; // IF PHOTO IS LESS THAN 500KB, THAN COMPRESS TO 30%, ELSE 10%

                  quality = file.size <= 500 * 1024 ? 0.3 : 0.1;
                  new Compressor(file, {
                    quality: quality,
...
},{"axios":"../../node_modules/axios/index.js","../view/baseView":"view/baseView.js"}],"view/searchView.js":[function(require,module,exports) {
"use strict";
...
var customAlert = _interopRequireWildcard(require("./customAlert"));

var profile = _interopRequireWildcard(require("../controller/profile"));
...
var handleSearch = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var input, res, noteMarkup, resultsMarkup, i, user, imgUser, actionBtn, resultItemMarkup;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            input = baseView.DOMElements.modalSearchInput.value;
          ...
          case 3:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/users/search/".concat(input)
            });
          ...
          case 8:
            ...
            noteMarkup = "<div class = \"modal__zero\">No result Found!! Try Searching Something else!!\n      ";
            baseView.DOMElements.modalSearchResults.insertAdjacentHTML('afterbegin', noteMarkup);
            return _context.abrupt("return");
          ...
          case 15:
            ...
            for (i = 0; i < res.data.users.length; i++) {
              ...
              if (user.photo) {
                imgUser = "\n      <img\n          src=\"/images/users/".concat(user.photo, "\"\n          class=\"userInfoBasic__photo\"\n        />");
              }

              actionBtn = "<span\n      class=\"btn btn--primary btn--small userInfoBasic__action__follow\"\n      data-userid = \"".concat(user.id, "\">Follow</span>");

              if (res.data.loggedInUser.following.includes(user.id)) {
                actionBtn = "<span\n        class=\"btn btn--primary btn--small userInfoBasic__action__follow profile__btn--following\"\n        data-userid = \"".concat(user.id, "\">Following</span>");
              }

              resultItemMarkup = "<li class=\"modal-search__results__item\">\n    <a href=\"/user/".concat(user.username, "\" class=\"modal-search__results__item__link\">\n      <div class=\"userInfoBasic\">\n        ").concat(imgUser, "\n        <div class=\"userInfoBasic__info\">\n          <div class=\"userInfoBasic__info__username\">\n            ").concat(user.username, "\n          </div>\n          <div class=\"userInfoBasic__info__name\">\n            ").concat(user.name, "\n          </div>\n        </div>\n        <div class=\"userInfoBasic__action\">\n          ").concat(actionBtn, "\n          \n        </div>\n      </div>\n    </a>\n  </li>");
              resultsMarkup = resultsMarkup + resultItemMarkup;
            }

            baseView.DOMElements.modalSearchResults.insertAdjacentHTML('afterbegin', resultsMarkup); // REGISTER THE CLICK ON FOLLOW BTN

            Array.from(baseView.DOMElements.modalSearchResults.querySelectorAll('.userInfoBasic__action__follow')).forEach(function (el) {
...
},{"axios":"../../node_modules/axios/index.js","./baseView":"view/baseView.js","./customAlert":"view/customAlert.js","../controller/profile":"controller/profile.js","../util/utilBase":"util/utilBase.js"}],"view/postView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addPostImg = exports.handleDblClickPost = exports.handleClickPost = void 0;

var _axios = _interopRequireDefault(require("axios"));

var baseView = _interopRequireWildcard(require("./baseView"));

var _commentView = require("./commentView");

var customAlert = _interopRequireWildcard(require("../view/customAlert"));
...
var likePost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el, post, fn) {
    var heartMarkup, postId, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (el.querySelector('.fadedHeart')) {
              el.querySelector('.fadedHeart').parentNode.removeChild(el.querySelector('.fadedHeart'));
            }
            ...
            post.likeBtnIcon.setAttribute('xlink:href', '/icons/sprite.svg#icon-favorite');
            post.likeBtn.classList.add('likingHeart');
            post.likeBtn.classList.add('likedHeart'); // CREATING A LIKE OBJECT
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts/").concat(postId, "/likes")
            });
  ...
  return function likePost(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}(); // ########################
...
var unlikePost = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(el, post) {
    var postId, likeId, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            post.likeBtnIcon.setAttribute('xlink:href', '/icons/sprite.svg#icon-favorite_outline');
            post.likeBtn.classList.remove('likingHeart');
            post.likeBtn.classList.remove('likedHeart'); // DELETING THE LIKED OBJ
            // GET THE POSTID FROM BODY(DATA ATTRIBUTE)

            postId = el.dataset.postid || null;
            likeId = post.likeBtn.dataset.likeid || null;
            _context2.prev = 6;
            _context2.next = 9;
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts/").concat(postId, "/likes/").concat(likeId)
            });
  ...
  return function unlikePost(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}(); // ########################
...
var toggleLike = function toggleLike(el, post) {
  if (!Array.from(post.likeBtn.classList).includes('likedHeart')) {
    likePost(el, post);
  } else {
    unlikePost(el, post);
...
var createPostDom = function createPostDom(el) {
  var post = {
...
var handleClickPostMore = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var el, postId, post, result, text;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (!(e.target.matches('.post__more__list__item--delete') || e.target.matches('.post__more__list__item--delete *'))) {
              _context3.next = 12;
              break;
            }
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts/").concat(postId)
            });

          case 6:
            utilBase.removeLoader(baseView.DOMElements.modalForLoader, true); // DELETE THE POST FROM UI

            post = document.querySelector(".post[data-postid='".concat(postId, "'"));
          ...
          case 12:
            if (!(e.target.matches('.post__more__list__item--copy') || e.target.matches('.post__more__list__item--copy *'))) {
              _context3.next = 22;
              break;
            }
  ...
  return function handleClickPostMore(_x6) {
    return _ref3.apply(this, arguments);
  };
}(); //######################################
...
var handleClickPost = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var el, postId, post;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            el = this;
            postId = el.dataset.postid || null;
            post = createPostDom(el); // WHEN CLICKED ON HEART ICON

            if (!(e.target.matches('.post__actions__icon--like') || e.target.matches('.post__actions__icon--like *'))) {
              _context4.next = 7;
              break;
            }
          ...
          case 7:
            if (!(e.target.matches('.post__actions__icon--comment') || e.target.matches('.post__actions__icon--comment *') || e.target.matches('.post__comments__link'))) {
              _context4.next = 12;
              break;
            }

            _context4.next = 10;
            return (0, _commentView.showComments)(el, e);
          ...
          case 12:
            if (!(e.target.matches('.post__more__btn') || e.target.matches('.post__more__btn *'))) {
              _context4.next = 16;
              break;
            }

            el.querySelector('.post__more__list').classList.toggle('post__more__list--show'); // el.querySelector('.post__more').insertAdjacentHTML(
            //   'beforeend',
            //   markupMore
            // );
          ...
          case 16:
            if (!(e.target.matches('.post__more__list') || e.target.matches('.post__more__list *'))) {
              _context4.next = 19;
              break;
            }

            _context4.next = 19;
            return handleClickPostMore(e);
  ...
  return function handleClickPost(_x7) {
    return _ref4.apply(this, arguments);
  };
}(); // ########################
...
exports.handleClickPost = handleClickPost;

var handleDblClickPost = function handleDblClickPost(e) {
  var el = this;
  var post = createPostDom(el); // FOR IMAGE

  if (e.target.matches('.post__img') || e.target.matches('.post__img *') // FOR HEART
  ) {
      likePost(el, post, function (markup) {
        post.img.insertAdjacentHTML('beforeend', markup);
      });
    } // FOR POST TEXT
  else if (e.target.matches('.post__info--main') || e.target.matches('.post__info--main *')) {
      likePost(el, post, function (markup) {
...
exports.handleDblClickPost = handleDblClickPost;

var addPostImg = function addPostImg() {
  ...
  if (baseView.DOMElements.addPostTextarea[0].value != '') {
    baseView.DOMElements.addPostTextarea[1].value = baseView.DOMElements.addPostTextarea[0].value;
...
exports.addPostImg = addPostImg;
},{"axios":"../../node_modules/axios/index.js","./baseView":"view/baseView.js","./commentView":"view/commentView.js","../view/customAlert":"view/customAlert.js","../util/utilBase":"util/utilBase.js"}],"view/validate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.validateEditProfile = exports.validateLogin = void 0;
...
var toggleInputError = function toggleInputError(el) {
  var error = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  var msg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Invalid';
  var notice = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var temp; // IF ITS THE PASSWORD FIELD
  ...
  if (temp.parentElement.querySelector('.form__field__successValidation')) {
    temp.parentElement.removeChild(temp.parentElement.querySelector('.form__field__successValidation'));
  }

  if (temp.parentElement.querySelector('.form__field__errorValidation')) {
    temp.parentElement.removeChild(temp.parentElement.querySelector('.form__field__errorValidation'));
  }

  if (error) {
    el.style.borderBottomColor = '#dc3545'; // IF ITS THE PASSWORD FIELD
    ...
    if (!el.parentElement.querySelector('.form__field__errorValidation')) {
      var markUp = "\n  <div class = 'form__field__errorValidation'>".concat(msg, "</div>");
      el.insertAdjacentHTML('afterend', markUp);
    }
  } // IF VALIDATION SUCCEEDS
  else {
      el.style.borderBottomColor = '#28a745'; // IF ITS THE PASSWORD FIELD
      ...
      if (notice) {
        if (!el.parentElement.querySelector('.form__field__successValidation')) {
          var _markUp = "\n    <div class = 'form__field__successValidation'>".concat(msg, "</div>");

          el.insertAdjacentHTML('afterend', _markUp);
        }
      }
    }
}; //######################################
...
var validateLogin = function validateLogin(e) {
  var el = e.target;
  console.log(e.target);

  if (Array.from(el.classList).includes('inputEmail')) {
    // VALIDATE EMAIL
    var indexOfAt = el.value.indexOf('@');
    var lastIndexOfDot = el.value.lastIndexOf('.');
    ...
    if (el.value && el.value.includes('@') && indexOfAt > 2 && lastIndexOfDot - indexOfAt > 3 && el.value.length - lastIndexOfDot > 2) {
      // EMAIL CONDITIONS :
      ...
      if (baseView.DOMElements.inputPassword.value && baseView.DOMElements.inputPassword.value.length >= 6) {
        toggleInputError(el, false);
      } else {
...
var validateEditProfile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var el, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            if (!(baseView.globalVars.inputUsernameValue && baseView.globalVars.inputUsernameValue === el.value)) {
              _context.next = 10;
              break;
            }
          ...
          case 10:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/users/".concat(el.value)
            });
          ...
          case 24:
            ...
            customAlert.alertPrimary(_context.t0.response.data.message);
  ...
  return function validateEditProfile() {
    return _ref.apply(this, arguments);
  };
}(); //######################################
...
},{"axios":"../../node_modules/axios/index.js","./baseView":"view/baseView.js","../view/customAlert":"view/customAlert.js"}],"controller/authenticate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.logout = exports.editProfile = exports.signup = exports.login = void 0;

var _axios = _interopRequireDefault(require("axios"));

var baseView = _interopRequireWildcard(require("../view/baseView"));

var validate = _interopRequireWildcard(require("../view/validate"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            baseView.DOMElements.inputs.forEach(function (el) {
            ...
            if (!baseView.DOMElements.formLogin.querySelector('.form__field__errorValidation')) {
              _context.next = 5;
              break;
            }
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(gToken, username) {
    var data, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            ...
            customAlert.alertPrimary(_context2.t0.response.data.message);
...
var editProfile = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(username, name, bio) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            name = name.trim();
            baseView.DOMElements.inputs.forEach(function (el) {
              return validate.validateEditProfile;
            }); // IF THERE ARE ANY ELEMENT HAVING CLASS ERRORVALIDATION, THAN IT MEANS THE VALIDATION HAS FAILED

            if (!baseView.DOMElements.formEditProfile.querySelector('.form__field__errorValidation')) {
              _context3.next = 5;
              break;
            }
          ...
          case 14:
            ...
            customAlert.alertPrimary(_context3.t0.response.data.message);
  ...
  return function editProfile(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}(); // LOGGING OUT
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            customAlert.alertPrimary(_context4.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","../view/baseView":"view/baseView.js","../view/validate":"view/validate.js","../view/customAlert":"view/customAlert.js","../util/utilBase":"util/utilBase.js"}],"../../node_modules/compressorjs/dist/compressor.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Compressor = factory());
})(this, function () {
  'use strict';
...
},{}],"controller/posts.js":[function(require,module,exports) {
"use strict";
...
var postView = _interopRequireWildcard(require("./../view/postView"));
...
var addPostUI = function addPostUI(post) {
  var userPhoto = post.user.photo ? "<img\n      src=\"images/users/".concat(post.user.photo, "\"\n      alt=\"post.user.userId\"\n      class=\"post__user__photo\"\n    />") : "<svg class = \"post__user__icon\">\n    <use xlink:href='icons/sprite.svg#icon-account_circle'></use>\n    </svg>"; // IF POST IMAGE EXIST

  var postImg = "";
  var postDescImg = "";

  if (post.photo) {
    postImg = "<div class=\"post__img\">\n    <img\n      src=\"images/posts/".concat(post.photo, "\"\n      alt=\"").concat(post.photo, "\"\n      class=\"post__img__src\"\n    />\n  </div>");
    postDescImg = "<div class=\"post__info\">\n  <div class=\"post__description\">\n    <span class=\"post__description__user\">".concat(post.user.username, "</span>: ").concat(post.description, "\n  </div>\n  </div>");
  } else {
    postImg = "<div class=\"post__info post__info--main\">\n    <div class=\"post__description--main\">".concat(post.description, "</div>\n    </div>");
  }

  var comments = "<div class = \"post__comments__notExist\"> No Comments!!</div>";

  if (post.comments.length > 0) {
    comments = "<a href=\"#\" class=\"post__comments__link\">View All Comments</a>\n    <!-- ONE COMMENT BOX-->\n    <div class=\"post__comment\">\n      <div class=\"post__comment__description\">\n        <span class=\"post__comment__user\">".concat(post.comments[0].user.username, ": </span>").concat(post.comments[0].comments, "\n      </div>\n      <div class=\"post__comment__footer\">\n        <div class=\"post__comment__time\">").concat(fromNowPast(Date.parse(post.comments[0].commentedOn)), "</div>\n        <div class=\"post__comment__reply\">Reply</div>\n        <svg class=\"post__comment__icon post__comment__icon--like\">\n          <use xlink:href=\"icons/sprite.svg#icon-favorite_outline\"></use>\n        </svg>\n      </div>\n    </div>\n    <!-- ############################# -->");
  }

  var markupPost = "\n  <!-- POST BOX -->\n  <div class=\"post row addingBox postAdding\" data-postid=\"".concat(post.id, "\">\n    <div class=\"post__header\">\n      <div class=\"post__user\">\n        <!-- IF ELSE -->\n        ").concat(userPhoto, "\n        <!-- #### -->\n        <span class=\"post__user__name\">").concat(post.user.username, "</span>\n      </div>\n\n      <div class=\"post__time\">\n        <div class=\"post__time__date\">").concat(new Date(Date.parse(post.postedOn)).toLocaleString('en', {
    day: 'numeric',
    month: 'long'
  }), "</div>\n        <div class=\"post__time__clock\">").concat(new Date(Date.parse(post.postedOn)).toLocaleTimeString('en-US', {
    hour: '2-digit',
    minute: '2-digit'
  }), "</div>\n      </div>\n      <div class=\"post__more\">\n        <svg class=\"post__more__btn\">\n          <use\n            xlink:href=\"icons/sprite.svg#icon-keyboard_control\n           \"\n          ></use>\n        </svg>\n        <div class=\"post__more__list\" data-postid = \"").concat(post.id, "\">\n                <div class=\"post__more__list__item post__more__list__item--copy\">Copy Link</div>\n                <div class=\"post__more__list__item post__more__list__item--delete\">Delete</div>\n              </div>\n      </div>\n    </div>\n    <div class=\"post__body\">\n      <!-- IF PHOTO EXIST -->\n      ").concat(postImg, "\n      <!-- ### -->\n      <div class=\"post__actions\">\n        <svg class=\"post__actions__icon post__actions__icon--like\">\n          <use xlink:href=\"icons/sprite.svg#icon-favorite_outline\"></use>\n        </svg>\n        <svg class=\"post__actions__icon post__actions__icon--comment\">\n          <use xlink:href=\"icons/sprite.svg#icon-forum\"></use>\n        </svg>\n        <svg class=\"post__actions__icon post__actions__icon--message\">\n          <use xlink:href=\"icons/sprite.svg#icon-paper-plane\"></use>\n        </svg>\n      </div>\n      <!-- IF PHOTO EXIST -->\n     ").concat(postDescImg, "\n    </div>\n    <div class=\"post__footer\">\n      <div class=\"post__comments\">\n        ").concat(comments, "\n      </div>\n    </div>\n  </div>\n  <!-- ############################# -->\n  ");
  baseView.DOMElements.sectonPosts.insertAdjacentHTML('afterbegin', markupPost); // CLOSE THE MODAL IF EXIST

  if (baseView.DOMElements.addPostModal) baseView.DOMElements.addPostModal.classList.remove('modal--show');
  baseView.DOMElements.addPostTextarea[0].value = ''; // SELECTING THE POST AND ATTACHING EVENTS

  var curPost = document.querySelector('.postAdding');
...
var addPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var form, postDesc, file, res, quality;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            form = new FormData();
            postDesc = baseView.DOMElements.addPostTextarea[0].value ? baseView.DOMElements.addPostTextarea[0].value : baseView.DOMElements.addPostTextarea[1].value;
            form.append('description', postDesc);
            utilBase.showLoader(baseView.DOMElements.modalForLoader, true);

            if (!(baseView.DOMElements.postPhotoInput && baseView.DOMElements.postPhotoInput.files && baseView.DOMElements.postPhotoInput.files.length > 0)) {
              _context2.next = 11;
              break;
            }

            file = baseView.DOMElements.postPhotoInput.files[0]; // IF PHOTO IS LESS THAN 500KB, THAN COMPRESS TO 30%, ELSE 10%
                      ...
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            ...
                            url: "/api/v1/users/".concat(baseView.globalVars.loggedInUserId, "/posts"),
                            data: form
                          });
...
},{"compressorjs":"../../node_modules/compressorjs/dist/compressor.js","./../view/baseView":"view/baseView.js","./../view/postView":"view/postView.js","axios":"../../node_modules/axios/index.js","../util/utilBase":"util/utilBase.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var commentView = _interopRequireWildcard(require("./view/commentView"));
...
var posts = _interopRequireWildcard(require("./controller/posts"));

var _dateUtil = require("./util/dateUtil");

var _utilBase = require("./util/utilBase");
...
(function () {
  ...
  if (baseView.DOMElements.formLogin) {
    ...
    baseView.DOMElements.formLogin.addEventListener('submit', function (e) {
      e.preventDefault();
      authenticate.login(baseView.DOMElements.inputEmail.value, baseView.DOMElements.inputPassword.value);
    });
  ...
  if (baseView.DOMElements.formEditProfile) {
    ...
    baseView.DOMElements.formEditProfile.addEventListener('submit', function (e) {
      e.preventDefault();
      authenticate.editProfile(baseView.DOMElements.inputUsername.value, baseView.DOMElements.inputName.value, baseView.DOMElements.inputBio.value);
    });
  } // HANDLING PASSWORD TOGGLE BTN


  if (baseView.DOMElements.passwordToggleBtn) {
    baseView.DOMElements.passwordToggleBtn.addEventListener('click', baseView.togglePasswordText);
  } // HANDLING CLICK ON POST


  if (baseView.DOMElements.post.length > 0) {
    baseView.DOMElements.post.forEach(function (el) {
  ...
  if (baseView.DOMElements.modalComments) {
    baseView.DOMElements.modalComments.addEventListener('click', commentView.handleClickCommentModal);
  } // HANDLE CLICK ON CONFIRMATION MODAL


  if (baseView.DOMElements.modalConfirmation) {
    baseView.DOMElements.modalConfirmation.addEventListener('click', commentView.handleClickConfirmationModal);
  } // MODIFYING THE TIME IN POST COMMENT (WHICH WILL BE SHOWING DOWN EACH POSTS)


  window.addEventListener('load', function () {
    var commentTimeObjArr = Array.from(document.querySelectorAll('.post__comment__time'));
    commentTimeObjArr.forEach(function (el) {
      el.textContent = (0, _dateUtil.fromNowPast)(Date.parse(el.dataset.timeadded));
    });
  }); // HANDLING SELECTION OF IMG ON ADD_POST

  if (baseView.DOMElements.postPhotoInput) {
    baseView.DOMElements.postPhotoInput.addEventListener('change', postView.addPostImg);
  } // MAKING TEXTAREA FLEXIBLE (AUTOSIZE)


  if (baseView.DOMElements.textareaFlexibleArr.length > 0) {
    baseView.DOMElements.textareaFlexibleArr.forEach(function (el) {
      el.addEventListener('input', _utilBase.autoSizeTextarea);
    });
  } // CREATING POST INFO (SUBMITTING)


  if (baseView.DOMElements.addPostSubmitInfo) {
    baseView.DOMElements.addPostSubmitInfo.addEventListener('click', posts.addPost);
  } // CREATING POST INFO (SUBMITTING)


  if (baseView.DOMElements.addPostSubmitImg) {
    baseView.DOMElements.addPostSubmitImg.addEventListener('click', posts.addPost);
  } // HANDLING CLICK ON FOLLOW BTN


  if (baseView.DOMElements.profileFollowBtn) {
    baseView.DOMElements.profileFollowBtn.addEventListener('click', profile.follow(baseView.DOMElements.profile.dataset.userid, baseView.DOMElements.profileFollowBtn));
  } // HANDLING CLICK ON SEARCH BTN (NAV)


  if (baseView.DOMElements.navSearchBtn) {
    baseView.DOMElements.navSearchBtn.addEventListener('click', function () {
  ...
  if (baseView.DOMElements.modalBackBtnArr.length > 0) {
    baseView.DOMElements.modalBackBtnArr.forEach(function (el) {
  ...
  if (baseView.DOMElements.modalSearchInput) {
    baseView.DOMElements.modalSearchInput.addEventListener('keyup', searchView.handleSearch);
  } // UPLOADING PROFILE PIC


  if (baseView.DOMElements.userPhotoInput) {
    baseView.DOMElements.userPhotoInput.addEventListener('change', profile.uploadPic);
  ...
  function attachSignin(element) {
    auth2.attachClickHandler(element, {}, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(googleUser) {
        var _profile;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _profile = auth2.currentUser.get().getBasicProfile();
                gToken = googleUser.getAuthResponse().id_token; // baseView.DOMElements.modalSignUp.classList.add('modal--show');

                _context.next = 5;
                return authenticate.signup(gToken);
  ...
  var signupG = function signupG() {
    gapi.load('auth2', function () {
      // Retrieve the singleton for the GoogleAuth library and set up the client.
      auth2 = gapi.auth2.init({
        client_id: '571304503104-d6h3eq23f1hqc3sjnhj2vscidh7qrlb7.apps.googleusercontent.com',
  ...
  if (baseView.DOMElements.formSignup) {
    baseView.DOMElements.inputUsername.addEventListener('keyup', validate.validateEditProfile);
    baseView.DOMElements.formSignup.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                e.preventDefault();
                st = validate.validateEditProfile.call(baseView.DOMElements.inputUsername.value);
                ...
                _context2.next = 5;
                return authenticate.signup(gToken, baseView.DOMElements.inputUsername.value);
  ...
  if (baseView.DOMElements.signOutBtn) {
    baseView.DOMElements.signOutBtn.addEventListener('click', authenticate.logout);
  ...
  if (baseView.DOMElements.modalWelcome) {
    ...
    baseView.DOMElements.modalWelcomeClose.addEventListener('click', function () {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43501" + '/');
